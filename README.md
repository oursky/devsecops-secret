...
## Known Problem
mac's bash is ancient and do not support associative array. (see [this](https://stackoverflow.com/questions/6047648/bash-4-associative-arrays-error-declare-a-invalid-option)).
If you encount this:
```
